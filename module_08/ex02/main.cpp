...
/*   Updated: 2026/01/23 15:29:33 by brivera          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    std::cout << BOLD << BRIGHT_BLUE
              << "=== TEST MUTANT STACK (Subject) ===" << RESET << std::endl;
