...
/*   Updated: 2025/12/08 13:15:14 by brivera          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class AForm
{
	...
	public:
		...
		/* 
		 * Ejecuta el formulario: la implementación base realiza las comprobaciones
		 * comunes (si está firmado y si el ejecutor tiene suficiente grado) y
		 * delega la acción concreta a _executeAction(). Esto evita repetir
		 * validaciones en cada clase derivada.
		 */
